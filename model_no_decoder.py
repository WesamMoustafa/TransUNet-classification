...
class VisionTransformer(nn.Module):
    ...
    def load_from(self, weights):
        with torch.no_grad():
            ...
            self.transformer.embeddings.patch_embeddings.bias.copy_(  # type: ignore
            ...
            if self.transformer.embeddings.hybrid:
                self.transformer.embeddings.hybrid_model.root.conv.weight.copy_(  # type: ignore  # noqa: E501
                    np2th(res_weight["conv_root/kernel"], conv=True)
                )  # type: ignore
                gn_weight = np2th(res_weight["gn_root/scale"]).view(-1)
                gn_bias = np2th(res_weight["gn_root/bias"]).view(-1)
                self.transformer.embeddings.hybrid_model.root.gn.weight.copy_(gn_weight)  # type: ignore  # noqa: E501
                self.transformer.embeddings.hybrid_model.root.gn.bias.copy_(gn_bias)  # type: ignore  # noqa: E501
                ...
                for (
                    ...
                    for uname, unit in block.named_children():
                        unit.load_from(res_weight, n_block=bname, n_unit=uname)  # type: ignore  # noqa: E501
